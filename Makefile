...
SRCS        = $(SRCS_DIR)minishell.c $(SRCS_DIR)free_all.c $(SRCS_DIR)get_envp_path.c $(SRCS_DIR)expander.c \
			  ...
			  $(COMMANDS_DIR)export_utils.c $(EXC_DIR)doc_handler_utils.c $(EXC_DIR)doc_handler_utils2.c $(SRCS_DIR)minishell_loop.c \
			  $(SRCS_DIR)get_envp_path_utils.c $(COMMANDS_DIR)atoll_utils.c $(COMMANDS_DIR)cd_dash.c
