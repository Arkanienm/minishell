...
SRCS        = $(SRCS_DIR)minishell.c $(SRCS_DIR)free_all.c $(SRCS_DIR)get_envp_path.c $(SRCS_DIR)expander.c \
			  ...
			  $(EXC_DIR)execution_utils.c $(EXC_DIR)execution_utils2.c $(EXC_DIR)execution_utils3.c $(EXC_DIR)doc_handler_utils4.c $(EXC_DIR)doc_handler_utils5.c \
			  $(EXC_DIR)execution_utils4.c
